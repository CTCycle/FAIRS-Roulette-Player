...
title FAIRS Test Runner
echo.
echo ============================================================================
echo    FAIRS E2E Test Runner
echo ============================================================================
echo.
...
if not exist "%python_exe%" (
    echo [ERROR] Python not found. Please run FAIRS\start_on_windows.bat first.
    goto error
)
if not exist "%uv_exe%" (
    echo [ERROR] uv not found. Please run FAIRS\start_on_windows.bat first.
    goto error
)
if not exist "%node_exe%" (
    echo [ERROR] Node.js not found. Please run FAIRS\start_on_windows.bat first.
    goto error
)
