...
3. Select the next release version, integrate the validated tree onto synchronized `main`, run hosted CI on that exact candidate, and create the annotated release tag.
