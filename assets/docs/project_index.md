...
The documentation set is synchronized with the current `2.6.0` codebase: local Windows web runtime, portable Python `3.14.2`, Node.js `22.13.0`, FastAPI backend, and React/Vite frontend.
