...
- `npm run build` produces the frontend used by `npm run preview`; the launcher invokes this after dependency installation in option 2 and during option 1 recovery when the environment or build is unusable
