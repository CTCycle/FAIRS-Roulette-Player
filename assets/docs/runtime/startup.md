...
- tracks the wrapper processes it starts and refuses to terminate an unrelated listener on a configured port; use option 2 to stop the application explicitly
