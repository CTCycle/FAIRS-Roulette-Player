"""Rename inference confidence storage to relative preference.

Revision ID: 0002_relative_preference
...
revision: str = "0002_relative_preference"
...
def upgrade() -> None:
    with op.batch_alter_table(
        ...
        batch_op.create_check_constraint(
            ...
            "(predicted_relative_preference >= 0 AND predicted_relative_preference <= 1)",
        )
